...
const NAV_GROUPS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/hr/eleave", label: "E-Leave", icon: Calendar, module: "hr" },
      { to: "/hr/eleave/apply", label: "Apply Leave", icon: ClipboardList, module: "hr" },
      { to: "/hr/eleave/my-requests", label: "My Requests", icon: ClipboardList, module: "hr" },
      { to: "/hr/eleave/approvals", label: "Approval Inbox", icon: ClipboardList, module: "hr" },
      { to: "/hr/eleave/calendar", label: "Team Calendar", icon: Calendar, module: "hr" },
      { to: "/hr/eleave/whos-on-leave", label: "Who's on Leave", icon: Users, module: "hr" },
      { to: "/hr/eleave/replacement", label: "Replacement", icon: ClipboardList, module: "hr" },
      { to: "/hr/eleave/holidays", label: "Public Holidays", icon: Calendar, module: "hr" },
